-- Create table employee, branch, client, works_with, branch_supplier
...
SELECT first_name as TEN, last_name as HO
FROM employee;
...
-- FIND NAME OF ALL EMPLOYEE WHO HAVE SOLD OVER 30,000 TO A SINGLE CLIENT
